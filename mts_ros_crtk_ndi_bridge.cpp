                                     ...
                                     const double _tf_period_in_seconds)
{
    ...
    m_subscribers_bridge->AddSubscriberToCommandWrite<std::string, std_msgs::msg::String>
    ...
    m_events_bridge->AddPublisherFromEventWrite<std::string, std_msgs::msg::String>
        (_required_interface_name, "Connected", _clean_namespace + "connected");
    // beep
    m_subscribers_bridge->AddSubscriberToCommandWrite<int, std_msgs::msg::Int32>
        (_required_interface_name, "Beep", _clean_namespace + "beep");
    // tracking
    m_subscribers_bridge->AddSubscriberToCommandWrite<bool, std_msgs::msg::Bool>
        (_required_interface_name, "Track", _clean_namespace + "track");
    m_events_bridge->AddPublisherFromEventWrite<bool, std_msgs::msg::Bool>
